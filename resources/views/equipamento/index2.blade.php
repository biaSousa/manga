...
<section class="container-fluid">
    <form id="form" class="form-horizontal" method="POST" action="{{url('equipamento/store')}}" onsubmit="oController.salvar(event)">
        <h3 class="card-header">Novo Equipamento</h3>
                ...
                <div class="row">
                    <div class="form-group">
                        <div class="col-md-3 mr-5">
                            ...
                            <input type="patrimonio" id="patrimonio" name="patrimonio" class="form-control" list="patrimonios"  placeholder="xxxxxx-xxxxxx">
                        ...
                        <div class="col-md-3 mr-5">
                            ...
                            <input type="numero" id="numero" name="numero" class="form-control" placeholder="xxxxxx-xxxxxx">
                        </div>
                        <div class="col-md-3 mr-5">
