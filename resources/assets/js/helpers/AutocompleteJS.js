class AutocompleteJS {
    ...
    constructor(e, callback=null) {
        if(this._valida(e)) {
            ...
            this._callback = (typeof callback === 'function')? this._callback = callback : null;
    ...
    _valida(e) {
        if(typeof e === 'undefined'){
            alert('INFO AUTOCOMPLETE: Informe o parâmetro do autocomplete'); return false;
        }
        
        if(typeof e !== 'string'){
            alert("INFO AUTOCOMPLETE: O parâmetro do autocomplete deve ser uma 'String'"); return false;
        }
        
        this._select = document.getElementById(e);

        if(!this._select){
            alert(`INFO AUTOCOMPLETE: O ID '${e}' informado no parâmetro da classe está incorreto`); return false;
        }
    ...
    _createInput() {
        ...
        this._input.classList.add('autocompleteJS');
    ...
    _eventClick() {
        window.addEventListener('click', (e) => {
            ...
            if(e.target == this._input){ //selected input
                ...
                if (this._callback) {
                    this._callback(this._select.value, this._select);
                }
            }
            else {
                this._hide();
    ...
    _eventKey() {
        document.addEventListener('keydown', (e) => {
            if(e.target.classList.contains('autocompleteJS')){
                if(e.key === 'Enter') {
                    e.preventDefault();
