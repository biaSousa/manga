...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h3">Cadastro de Menu</h1>
</div>
<form id="form" method="post" action="{{url('seguranca/menu/store')}}" onsubmit="oController.salvar(event)">
    {{ csrf_field() }}
    <div class="row">
        ...
        <div class="col-md-4 mr-5">
            <div class="form-group">
                ...
                <input type="text" id="ordem" name="ordem" class="form-control form-control-sm">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-4 mr-5">
            <div class="form-group">
                ...
                <select class="form-control form-control-sm" name="pai" id="pai">
                    ...
                    <option value="{{$menu_raiz->id}}">{{$menu_raiz->nome}}</option>
                    @endforeach
                </select>
            </div>
        </div>
        <div class="col-md-4 mr-5">
            <div class="form-group">
                ...
                <input type="text" id="dica" name="dica" class="form-control form-control-sm">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-4 mr-5">
            <div class="form-group">
                <div class="checkbox">
                    <label>
                        <input type="checkbox" id="status" name="status" checked> Ativo
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 mr-5">
            <div class="form-group">
                ...
                <select class="form-control form-control-sm" name="acao" id="acao">
                    ...
                    <option value="{{$acao->id}}">{{$acao->nome_amigavel}}</option>
                    @endforeach
                </select>
            </div>
        </div>
...
<script src="{{asset('js/app/controllers/CriarMenuController.js')}}"></script>
<script>
    oController = new CriarMenuController();
</script>
@endsection