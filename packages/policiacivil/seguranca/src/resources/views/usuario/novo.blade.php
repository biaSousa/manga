...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h3">Inclusão de Usuário</h1>
</div>
<form id="form" method="post" action="{{url('seguranca/usuario/store')}}" onsubmit="oController.salvar(event)">
    {{ csrf_field() }}
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="form-group">
                ...
                <input type="text" id="nascimento" name="nascimento" class="form-control form-control-sm">
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-4 mr-5">
            <div class="form-group" id="form_linha_8">
        ...
        <div class="col-md-4 mr-5">
            <label>
                <input type="checkbox" id="diretor" name="diretor" onclick="oController.adicionarDiretor()" value="1"> Diretor Responsável
            </label>
        </div>
    </div>
    <!-- perfil -->
    ...
    <div class="form-group">
        <div class="checkbox col-sm-offset-2">
            <label>
                <input type="checkbox" id="trocar_senha" name="trocar_senha" checked> Forçar troca de senha no próximo login
            </label>
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="form-group">
            <button id="cancelar" class="btn btn-light" href="{{url('seguranca/usuario/admin')}}">Cancelar</button>
        </div>
    </div>
